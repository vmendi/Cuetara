package utils
{
	...
	public final class KeyboardHandler
	{
		...
		public static function Init(stage : Stage) : void
		{
			...
			stage.addEventListener(KeyboardEvent.KEY_DOWN, mInstance.OnKeyDown, false, 0, true);
			stage.addEventListener(KeyboardEvent.KEY_UP, mInstance.OnKeyUp, false, 0, true);
			
			stage.addEventListener(Event.ENTER_FRAME, mInstance.OnEnterFrame, false, 0, true);
		}
		...
		protected function OnEnterFrame(event:Event):void
		{
			...
			mStage.addEventListener(Event.ENTER_FRAME, mInstance.OnEnterFrame, false);
